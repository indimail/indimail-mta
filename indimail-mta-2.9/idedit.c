 ...
 * added RCS id
 *
 * Revision 1.6  2004-10-22 15:35:21+05:30  Cprogrammer
 * removed readwrite.h
 *
 * Revision 1.5  2004-07-17 21:19:10+05:30  Cprogrammer
 * added RCS log
 *
 */
#include <sys/types.h>
...
void
u(account, group, home, pos0, pos1, pos2, pos3)
	char           *account;
	char           *group;
	char           *home;
	char           *pos0;
	...
	char          **argv;
{
	...
	if (fd == -1)
		strerr_die4sys(111, FATAL, "unable to open ", argv[1], ": ");
