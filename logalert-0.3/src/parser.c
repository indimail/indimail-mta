...
static const yytype_uint8 yyprhs[] =
{
      ...
      25,    28,    31,    35,    39,    43,    47,    51,    53
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      15,     0,    -1,    -1,    15,    16,    -1,    15,    17,    -1,
      15,    18,    -1,    15,    19,    -1,    15,    20,    -1,    15,
      21,    -1,    15,    22,    -1,    15,    23,    -1,     3,    12,
      -1,     4,    11,    12,    -1,     5,    11,    12,    -1,     6,
      11,    12,    -1,     7,    11,    12,    -1,     8,    11,    12,
      -1,     9,    -1,    10,    -1
};
...
{
  "$end", "error", "$undefined", "FILENAME", "MATCH", "EXECUTE", "SLEEP",
  "RETRY", "USER", "READALL", "VERBOSE", "EQUAL", "STRING", "NUMBER",
  "$accept", "config", "filename", "match", "exec", "sleep", "retry",
  "user", "readall", "verbose", 0
};
#endif
...
{
     -12,     0,   -12,   -11,    -9,     1,     2,     3,     4,   -12,
     -12,   -12,   -12,   -12,   -12,   -12,   -12,   -12,   -12,   -12,
      -1,     5,     6,     7,     8,   -12,   -12,   -12,   -12,   -12
};
...
{
       2,    19,    20,     3,     4,     5,     6,     7,     8,     9,
      10,    25,    21,    22,    23,    24,     0,    26,    27,    28,
      29
};

static const yytype_int8 yycheck[] =
{
       0,    12,    11,     3,     4,     5,     6,     7,     8,     9,
      10,    12,    11,    11,    11,    11,    -1,    12,    12,    12,
      12
};
