...
#ifndef	lint
static char     sccsid[] = "$Id: vauth_renamedomain.c,v 2.8 2009-02-18 21:34:49+05:30 Cprogrammer Stab mbhangui $";
#endif
...
vauth_renamedomain(char *OldDomain, char *NewDomain, char *domdir)
{
	...
	if(is_distributed_domain(OldDomain) && rename_data(ON_MASTER, cntrl_table, "pw_domain", NewDomain, OldDomain))
		err = 1;
	else
