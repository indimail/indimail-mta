...
static const char searchinfo_h_rcsid[]="$Id: searchinfo.h,v 1.9 2003/08/01 00:34:58 mrsam Exp $";
...
void search_set_charset_uc(struct searchinfo *, const struct unicode_info *);

void search_set_charset_conv(struct searchinfo *, const struct unicode_info *,
			     const struct unicode_info *);
