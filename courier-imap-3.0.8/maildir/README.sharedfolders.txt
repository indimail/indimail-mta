   ...
   Table Of Contents
   [1]Virtual shared folders
     [2]Terminology                                        
     [3]Technical Overview                                 
     [4]Functional Overview                                
     [5]Combining Courier-IMAP's and SqWebMail index files 
     
   [6]Filesystem permissions-based shared folders
     [7]Terminology                                        
     [8]Technical Overview                                 
     [9]Functional Overview                                
     [10]Accessing shared folders                          
     [11]Subscribing to a shared folder                    
     [12]Unsubscribing to a shared folder                  
     [13]Opening a shared folder                           
...
Functional Overview
 ...
 $sbindir/authenumerate >$sysconfdir/shared.tmp/index || exit 1
 ...
 $sbindir/sharedindexinstall
   ...
   accounts.
    ...
    NOTE
     ...
     Some systems with large numbers of accounts may not be able to use
     authenumerate due to its memory requirements. Particularly, MySQL and
     PostgreSQL client libraries typically download the complete results of
     each query into a memory buffer. It's possible that authenumerate's
     memory requirements may be large enough to affect the running system. In
     this case you will need to come up with an alternative mechanism to
     obtain the list of accounts, in some other way.
  ...
  Using sharedindexsplit
   ...
   As mentioned in the [15]technical overview, a single index file may not be
   ...
   sharedindexsplit splits the index into multiple files, based on the first
   character of the account's name. Use the optional second argument to
   sharedindexsplit to specify a number greater than one, if splitting the
   account list based on two or more initial characters is desired.
   ...
   Therefore, the following script should produce good result on a system
   with a large, but a moderate number of accounts:
...
Technical Overview
     ...
     * Messages in shared folders do not count towards any individual maildir
       quotas (see [16]README.maildirquota.html).
...
References
   ...
   Visible links
   1. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#newshared
   2. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#newsharedterm
   3. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#newsharedtech
   4. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#newsharedfunc
   5. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#combo
   6. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#oldshared
   7. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#oldsharedterm
   8. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#oldsharedtech
   9. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#oldsharedfunc
  10. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#oldsharedaccess
  11. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#oldsharedsub
  12. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#oldsharedunsub
  13. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#oldsharedopen
  14. file:///home/mrsam/src/courier-imap/maildir/maildiracl
  15. file:///home/mrsam/src/courier-imap/maildir/README.sharedfolders.html#newsharedtech
  16. file:///home/mrsam/src/courier-imap/maildir/README.maildirquota.html
