...
int foldertype  Q((int type, int forcedir, mode_t * const modep, struct stat * const paranoid));
int screenmailbox Q((char *chp, const gid_t egid, const int Deliverymode));

extern const char maildirnew[];
extern int      accspooldir;

#ifdef TESTING
static const char *FT2str[] = { "Not-Yet", "Can't-Create", "Too-Long",
