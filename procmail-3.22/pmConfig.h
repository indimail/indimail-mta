 ...
 * uncomment this if each user has his or her own
...
/*
 * #define LMTP
 * uncomment this if you want to use procmail
 ...
 * uncomment to prevent users with uids equal or higher than RESTRICT_EXEC from
 ...
 * uncomment if you're definitely not using NFS mounted filesystems and can't afford
...
/*
 * #define DEFsendmail  "/usr/sbin/sendmail"
 * uncomment and/or change if the autoconfigured default
 ...
 * uncomment if you want procmail to use the console (or any other
