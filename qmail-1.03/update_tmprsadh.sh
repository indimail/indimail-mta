...
umask 0077 || exit 0
MYUID=`/usr/xpg4/bin/id -u indimail`
MYGID=`/usr/xpg4/bin/id -g indimail`
...
chown $MYUID.$MYGID QMAIL/control/rsa512.new &&
...
chown $MYUID.$MYGID QMAIL/control/dh512.new &&
...
chown $MYUID.$MYGID QMAIL/control/dh1024.new &&
