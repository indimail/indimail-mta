...
%attr(551,root,qmail)                   %{_prefix}/sbin/relaytest
%attr(551,root,qmail)                   %{_prefix}/sbin/splogger
...
%attr(550,root,qmail)                   %{_prefix}/bin/qmail-newu
%attr(551,root,qmail)                   %{_prefix}/bin/qmail-pw2u
...
%attr(551,root,qmail)                   %{_prefix}/bin/qmail-remote
...
%attr(551,root,qmail)                   %{_prefix}/bin/qmail-getpw
...
%attr(550,root,qmail)                   %{_prefix}/bin/qmail-newmrh
...
%attr(551,root,qmail)                   %{_prefix}/bin/qmail-popup
%attr(555,root,qmail)                   %{_prefix}/bin/ofmipname
%attr(555,root,qmail)                   %{_prefix}/bin/822bodyfilter
%attr(551,root,qmail)                   %{_prefix}/bin/qmail-local
...
%attr(550,root,qmail)                   %{_prefix}/bin/qmail-cdb
...
%attr(550,root,qmail)                   %{_prefix}/bin/recipient-cdb
...
%attr(550,root,qmail)                   %{_prefix}/sbin/instcheck
...
%attr(550,root,qmail)                   %{_prefix}/sbin/qmail-daemon
%attr(550,root,qmail)                   %{_prefix}/sbin/qmail-start
%attr(551,root,qmail)                   %{_prefix}/sbin/qmail-clean
%attr(551,root,qmail)                   %{_prefix}/sbin/qmail-rspawn
%attr(550,root,qmail)                   %{_prefix}/sbin/qmail-lspawn
%attr(551,root,qmail)                   %{_prefix}/sbin/qmail-send
%attr(551,root,qmail)                   %{_prefix}/sbin/qmail-todo
...
%if %fedorareview == 0
%docdir %{mandir}
%attr(444,root,qmail)                   %{mandir}/man[1,4,5,7,8]/*
%attr(444,root,qmail)                   %{mandir}/cat[1,4,5,7,8]/*
%else
%attr(0644,root,qmail)                  %{mandir}/man1/qmail-qfilter.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/drate.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/replier-config.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/replier.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/condtomaildir.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/filterto.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/checkdomain.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/checkaddr.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822fields.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822addr.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822headerfilter.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822bodyfilter.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822headerok.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822body.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822print.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822received.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822date.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822header.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/822field.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/new-inject.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/ifaddr.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/iftoccfrom.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/iftocc.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/newinclude.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/setmaillist.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/printmaillist.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/inewaliases.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/setforward.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/printforward.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/fastforward.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/dot-forward.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/plugtest.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/qmail-rm.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/qaes.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/cdbdump.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/cdbmake.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/cdbstats.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/cdbtest.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/cdbgetm.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/cdbget.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/columnt.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/xrecipient.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/xsender.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/xqp.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/matchup.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/maildirserial.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/maildirsmtp.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/maildirqmtp.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/maildircmd.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/serialsmtp.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/serialqmtp.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/serialcmd.0.gz
%attr(0644,root,qmail)                  %{mandir}/man1/serialcmd.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/qarf.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/rrt.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/qnotify.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/autoresponder.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/maildirdeliver.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/relaytest.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/tcp-env.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/preline.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/qreceipt.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/mailsubj.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/maildirwatch.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/maildir2mbox.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/qmaildirmake.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/except.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/bouncesaying.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/condredirect.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/rrforward.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/forward.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/swaks.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/qbase64.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/uacl.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/recordio.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/fixcrio.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/delcr.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/addcr.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/argv0.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/datemail.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/predate.1.gz
%attr(0644,root,qmail)                  %{mandir}/man1/qmail-cat.1.gz
%if %nolibsrs2 == 0
%attr(0644,root,qmail)                  %{mandir}/man1/srs.1.gz
%endif
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-4870.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-4871.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-3798.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-3834.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-2476.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-2635.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-2505.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-2554.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-2645.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-2104.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-1321.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-1985.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-1894.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-1893.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-2821.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-1845.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rfc-822.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/qmtp.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/rewriting.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/tcp-environ.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/qmail-users.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/qmail-log.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/qmail-header.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/qmail-control.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/dot-qmail.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/mbox.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/maildir.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/envelopes.5.gz
%attr(0644,root,qmail)                  %{mandir}/man5/addresses.5.gz
%attr(0644,root,qmail)                  %{mandir}/man7/forgeries.7.gz
%attr(0644,root,qmail)                  %{mandir}/man7/qmail.7.gz
%attr(0644,root,qmail)                  %{mandir}/man7/qmail-limits.7.gz
%attr(0644,root,qmail)                  %{mandir}/man8/run-cleanq.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/cleanq.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qscanq-stdin.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qscanq.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/ldap-checkpwd.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/sys-checkpwd.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-command.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-poppass.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-smtpd.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-qmtpd.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-qmqpd.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-qmqpc.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-popup.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-pop3d.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-tcpto.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-tcpok.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/queue-fix.0.gz
%attr(0644,root,qmail)                  %{mandir}/man8/queue-fix.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-qread.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-pw2u.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-newu.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-cdb.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-sql.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/recipient-cdb.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-newmrh.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-showctl.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/irmail.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/isendmail.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-inject.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/spawn-filter.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/surblfilter.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-multi.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/dktest.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/dknewkey.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-dk.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/dk-filter.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-dkim.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-nullqueue.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-queue.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-internals.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/splogger.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-start.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-daemon.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-todo.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-send.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-clean.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-rspawn.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-remote.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-getpw.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-lspawn.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmail-local.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/qmailctl.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/ofmipname.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/ofmipd.8.gz
%attr(0644,root,qmail)                  %{mandir}/man8/mlmatchup.8.gz
%if %nolibdkim == 0
%attr(0644,root,qmail)                  %{mandir}/man8/dkim.8.gz
%endif

%attr(0644,root,qmail)                  %{mandir}/cat1/qmail-qfilter.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/replier-config.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/replier.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/condtomaildir.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/filterto.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/checkdomain.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/checkaddr.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822fields.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822addr.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822headerfilter.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822bodyfilter.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822headerok.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822body.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822print.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822received.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822date.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822header.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/822field.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/new-inject.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/ifaddr.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/iftoccfrom.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/iftocc.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/newinclude.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/setmaillist.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/printmaillist.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/newaliases.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/setforward.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/printforward.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/fastforward.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/dot-forward.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/qmail-rm.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/columnt.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/xrecipient.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/xsender.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/xqp.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/matchup.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/maildirserial.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/maildirsmtp.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/maildirqmtp.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/maildircmd.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/serialsmtp.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/serialqmtp.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/autoresponder.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/maildirdeliver.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/tcp-env.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/preline.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/qreceipt.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/mailsubj.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/maildirwatch.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/maildir2mbox.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/qmaildirmake.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/except.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/bouncesaying.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/condredirect.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/rrforward.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat1/forward.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/rewriting.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/tcp-environ.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/qmail-users.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/qmail-log.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/qmail-header.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/qmail-control.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/dot-qmail.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/mbox.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/maildir.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/envelopes.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat5/addresses.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat7/qmail.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/run-cleanq.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/cleanq.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qscanq-stdin.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qscanq.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-command.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-poppass.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-smtpd.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-qmtpd.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-qmqpd.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-qmqpc.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-popup.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-pop3d.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-tcpto.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-tcpok.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-qread.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-pw2u.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-newu.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-cdb.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/recipient-cdb.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-newmrh.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-showctl.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-inject.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/spawn-filter.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-multi.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-dk.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-queue.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/splogger.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-start.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-todo.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-send.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-clean.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-rspawn.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-remote.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-getpw.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-lspawn.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/qmail-local.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/ofmipname.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/ofmipd.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat8/mlmatchup.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat7/qmail-limits.0.gz
%attr(0644,root,qmail)                  %{mandir}/cat7/forgeries.0.gz
%endif
...
%endif
%attr(555,root,qmail)                   %{shareddir}/boot/binm2
%attr(555,root,qmail)                   %{shareddir}/boot/proc+df
%attr(555,root,qmail)                   %{shareddir}/boot/binm1+df
%attr(555,root,qmail)                   %{shareddir}/boot/binm3+df
%attr(555,root,qmail)                   %{shareddir}/boot/home+df
%attr(555,root,qmail)                   %{shareddir}/boot/binm3
%attr(555,root,qmail)                   %{shareddir}/boot/binm1
%attr(555,root,qmail)                   %{shareddir}/boot/proc
%attr(555,root,qmail)                   %{shareddir}/boot/home
%attr(555,root,qmail)                   %{shareddir}/boot/binm2+df
