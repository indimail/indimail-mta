...
%attr(755,root,qmail)                   %{_prefix}/bin/zrecipients
...
%attr(755,root,qmail)                   %{_prefix}/bin/rhosts
...
%attr(755,root,qmail)                   %{_prefix}/bin/zrhosts
...
%attr(755,root,qmail)                   %{_prefix}/bin/rsmtpsenders
%attr(755,root,qmail)                   %{_prefix}/bin/queue-fix
%attr(755,root,qmail)                   %{_prefix}/bin/822body
%attr(755,root,qmail)                   %{_prefix}/bin/zdeferrals
%attr(755,root,qmail)                   %{_prefix}/bin/dktest
%attr(755,root,qmail)                   %{_prefix}/bin/rspamstat
%attr(755,root,qmail)                   %{_prefix}/bin/iftoccfrom
%attr(755,root,qmail)                   %{_prefix}/bin/zsuids
...
%attr(755,root,qmail)                   %{_prefix}/bin/xrecipient
